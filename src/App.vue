      ...
      <div class="mx-auto mb-7 flex w-4/5 flex-col gap-7">
        <div class="flex flex-col gap-7 lg:flex-row lg:justify-between">
          ...
          <div class="flex items-center">
            <input
              ...
              class=" h-12 w-full rounded-lg border-2 border-indigo-100 px-4 placeholder:text-xs"/>
        ...
        <div class="flex items-center lg:hidden">
          <input
            ...
            class="h-16 w-full rounded-lg border-2 border-indigo-100 px-4 placeholder:text-xs"/>
